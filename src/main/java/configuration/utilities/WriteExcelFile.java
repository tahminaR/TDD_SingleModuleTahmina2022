...
public class WriteExcelFile {
    ...
    static String email = "Enaa" + random_integer + "@gmail.com";
    static String email2 = "Meena" + random_integer + "@gmail.com";
    static String email3 = "Deeka" + random_integer + "@gmail.com";
    ...
    public static void writeExcel(String fileName) {
        ...
        Object[][] stDetails = {
                ...
                {"1", "Adhora", "Neela", "888598759"},
                {"2", "Meghla", "Akash", "999598759"},
                {"2", "Purnima", "Raat", "777598759"},
        };
        int rowNum = 0;
